...
public class ListaOperadores extends javax.swing.JDialog {
    static public int opt;
    PersonalDao DP = new PersonalDao();
    DefaultTableModel modelo;
    
    ControladorEnviarDatos CED = new ControladorEnviarDatos();            
    public ListaOperadores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);      
        this.setLocationRelativeTo(null);
        initComponents();
        Controlador.Tablas.LlenarTablaPersonal((DefaultTableModel)tPersonal.getModel());   
    }
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        Controlador.Tablas.FiltrarTablaPersonal((DefaultTableModel) tPersonal.getModel(),txtBuscar.getText());        
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ListaOperadores dialog = new ListaOperadores(new javax.swing.JFrame(), true);
