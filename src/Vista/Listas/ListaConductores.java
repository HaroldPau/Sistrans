...
public class ListaConductores extends javax.swing.JDialog {
    ...
    public ListaConductores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);      
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaConductores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ListaConductores dialog = new ListaConductores(new javax.swing.JFrame(), true);
